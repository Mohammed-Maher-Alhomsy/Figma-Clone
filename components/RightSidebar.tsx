...
const RightSidebar = ({
  ...
  const handleInputChnage = (property: string, value: string) => {
  ...
  return (
    ...
    >
      ...
      <span className="text-xs text-primary-grey-300 mt-3 px-5 pb-4 border-b border-primary-grey-200">
      ...
      <Dimensions
        ...
        handleInputChange={handleInputChnage}
      />
